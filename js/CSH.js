...
$(document).bind('scroll.chart',function(){

    if( $(window).scrollTop() > ($('#abillity').offset().top - 500) ){
      var charts = [];
      [].forEach.call(document.querySelectorAll('.chart'),  function(el) {
        charts.push(new EasyPieChart(el, options));
      });
      $(document).unbind('.chart');
      return;
  }
...
$('.Coop_block').hover(
  ...
  function(){$('.frame1').css("display","block");},
  function(){$('.frame1').css("display","none");}
...
$('.Sys_block').hover(
  ...
  function(){$('.frame2').css("display","block");},
  function(){$('.frame2').css("display","none");}

);

$('.Hon_block').hover(

  function(){$('.frame3').css("display","block");},
  function(){$('.frame3').css("display","none");}

);

$('.Coop_block').hover(

  function(){$('#base_img').css("display","none");},
  function(){$('#base_img').css("display","block");}
